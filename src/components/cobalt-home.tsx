...
export const Hero = () => {
  return (
    <div className="my-44 flex w-full flex-col items-center selection:bg-secondary">
      ...
      <div className="mt-7 flex flex-col items-center justify-center">
        ...
        <button className="flex items-center flex-col mt-8 text-neutral-400 group hover:text-neutral-100 text-sm cursor-pointer">
          Learn more
          <ArrowDown className="text-sm mt-1 group-hover:mt-3 duration-200 transition-all" width={18} height={18} />
        </button>
      </div>
    </div>
  );
