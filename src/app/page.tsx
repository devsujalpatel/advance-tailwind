...
export default function Home() {
  ...
  return (
    <div className="relative flex h-full w-full items-center justify-center">
      <div className="relative z-10 h-80 w-60 overflow-hidden rounded-xl border border-neutral-100 bg-neutral-50 shadow-2xl">
        ...
        <div className="p-4">
          ...
          <p className="mt-2 text-[10px] text-neutral-400">
            I swear god there's always another AI dropping and twitter goes
            crazy. It's all a myth guys. Like seriosly, one day it's Claude 2,
            then GPT-4 Turbo, When will it end? They're all just fancy
            autocomplete.
          </p>
        </div>
      </div>
